...
void EXPERIMENT::Run()
{
   ...
   // cout << "Num Steps " << ExpParams.TimeOut;
    ...
    auto start = high_resolution_clock::now();
        ...
        cout << "Time in this step " << fs.count() << endl;// << ". Step is " << t << endl;
        ...
        if (outOfParticles)
            break;
        std::chrono::duration<float> fchk = high_resolution_clock::now() - startg;
        //cout << "Timer elapsed "<<timer.elapsed() << " Timeout " << ExpParams.TimeOut << "  " << fchk.count()<<endl;
        ...
        if (fchk.count() > ExpParams.TimeOut)
        {
            cout << "Timed out after " << t << " steps in "
                << Results.Time.GetTotal() << "seconds" << endl;
            break;
    ...
    std::chrono::duration<float> fsg = stopg - startg;
    //Results.Time.Add(timer.elapsed());
    Results.Time.Add(fsg.count());
