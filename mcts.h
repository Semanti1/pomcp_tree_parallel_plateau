...
public:
    ...
    double Rollout(STATE& state, int treedepth, HISTORY& hist);
...
private:
    ...
    double SimulateV(STATE& state, VNODE* vnode, int& treedepth, int& peaktreedepth, HISTORY& hist);
    //double SimulateQ(STATE& state, QNODE& qnode, int action);
    double SimulateQ(STATE& state, QNODE& qnode, int action, int& treedepth, int& peaktreedepth, HISTORY& hist);
   // void AddRave(VNODE* vnode, double totalReward, int treedepth,std::mutex* m);
    void AddRave(VNODE* vnode, double totalReward, int treedepth, HISTORY hist, std::mutex* m);
    VNODE* ExpandNode(const STATE* state, HISTORY& hist);
